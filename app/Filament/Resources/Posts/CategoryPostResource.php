...
use App\Filament\Resources\Posts\CategoryPostResource\Pages;
use App\Filament\Resources\Posts\CategoryPostResource\RelationManagers;
        ...
        return $table
            ->columns([
                ...
                IconColumn::make('status')
                    ...
                    ->action(
                        Action::make('Active')
                            ->label(fn(CategoryPost $record): string => $record->status ? __('panel.messages.deactivate') : __('panel.messages.activate'))
                            ->disabled(fn(Model $record): bool => !auth()->user()->can('update', $record))
                            ->requiresConfirmation()
                            ->action(fn(CategoryPost $record) => $record->toggleStatus())
